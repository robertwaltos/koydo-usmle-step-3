...
export const metadata: Metadata = {
  title: "Pricing — Usmle Step 3 Premium",
  description: "Unlock unlimited Usmle Step 3 practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=usmle-step-3&cadence=annual`;
