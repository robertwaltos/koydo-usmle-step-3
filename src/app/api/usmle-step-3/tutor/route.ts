...
const EXAM_ID = "usmle-step-3";
const EXAM_DISPLAY_NAME = "USMLE Step 3";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover ambulatory medicine, inpatient medicine, emergency medicine, preventive medicine. Focus on management decisions and CCS case logic.
